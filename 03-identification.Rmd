...
This section reparametrizes the LTP model as a multinomial distribution. The sample frequencies of the joint variable are sufficient statistics for the multinomial distribution. By drawing the analogy, it is can be proven that the sample frequencies of the joint distribution of item assignments, observed responses, stop decisions, and effort decisions are the sufficient statistics of the LTP model.
...
bc_param = data.frame(model=c('Knowledge','Guess','Reading Tutor'), pi=c(0.56,0.36,0.01),l=c(0.1,0.1,0.1),s=c(0.0,0.3,0.53),g=c(0.05,0.05,0.05) )
