...
raw_data_path = paste0(proj_dir,'/_data/02/raw_data.RData')
load(raw_data_path)
...
spell_data_path = paste0(proj_dir,'/_data/02/spell_data.RData')
...
#
#
# lag_spell_path = paste0(proj_dir,'/_data/02/spell_data_lag_3.csv')
...
# save.image(paste0(getwd(),'/_data/02/production_data.RData'))
#
#
#
#
