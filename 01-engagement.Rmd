...
(1) Initialize the state from the end by 
...
Appendix I.2 discuss the choice of prior in details. For the Gibbs sampler, it suffices to know that prior distribution for all parameters is set as Beta distribution.
...
m21 = ggplot(data=mcmc_est,aes(x=s)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$s,  colour="blue", linetype = "longdash") + 
    ggtitle('slip')

m22 = ggplot(data=mcmc_est,aes(x=g)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$g,  colour="blue", linetype = "longdash") + 
    ggtitle('guess')

m23 = ggplot(data=mcmc_est,aes(x=pi)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$pi,  colour="blue", linetype = "longdash") + 
    ggtitle('Initial Probability of Mastery')

m24 =ggplot(data=mcmc_est,aes(x=l)) + geom_histogram(binwidth=0.01) +
...
h11 = ggplot(data=mcmc_est,aes(x=h11)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h11,  colour="blue", linetype = "longdash") + 
    ggtitle('hazard rate | t = 1, Y=1')

h12 = ggplot(data=mcmc_est,aes(x=h12)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h12,  colour="blue", linetype = "longdash") + 
    ggtitle('hazard rate | t = 2, Y=1')

h13 = ggplot(data=mcmc_est,aes(x=h13)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h13, colour="blue", linetype = "longdash") + 
    ggtitle('hazard rate | t = 3, Y=1')

h14 = ggplot(data=mcmc_est,aes(x=h14)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h14,  colour="blue", linetype = "longdash") +
    ggtitle('hazard rate | t = 4, Y=1')

h15 = ggplot(data=mcmc_est,aes(x=h15)) + geom_histogram(binwidth=0.01) +
...
h01 = ggplot(data=mcmc_est,aes(x=h01)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h01, colour="blue", linetype = "longdash") + 
    ggtitle('hazard rate | t = 1, Y=0')

h02 = ggplot(data=mcmc_est,aes(x=h02)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h02, colour="blue", linetype = "longdash") + 
    ggtitle('hazard rate | t = 2, Y=0')

h03 = ggplot(data=mcmc_est,aes(x=h03)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h03, colour="blue", linetype = "longdash") + 
    ggtitle('hazard rate | t = 3, Y=0')

h04 = ggplot(data=mcmc_est,aes(x=h04)) + geom_histogram(binwidth=0.01) +
    geom_vline(xintercept=true_param$h04, colour="blue", linetype = "longdash") + 
    ggtitle('hazard rate | t = 4, Y=0')

h05 = ggplot(data=mcmc_est,aes(x=h05)) + geom_histogram(binwidth=0.01) +
