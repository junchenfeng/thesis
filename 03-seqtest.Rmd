...
The regret is hard to define in the simulated experiment since the true superior arm is unknown. However, the resulting success rate is a proxy for learning gain since the data set conditions on making initial mistakes. When there is a significant finding, the bandit test provides a modest boost to student's learning performance. However, when the truth is close to equivalent, the bandit test actually performs worse. **How COME**
